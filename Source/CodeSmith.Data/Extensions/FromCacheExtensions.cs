...
namespace CodeSmith.Data.Linq
{
    public static class FromCacheExtensions
    {
        ...
        public static IQueryable<T> FromCache<T>(this IQueryable<T> query)
        {
        ...
        /// <param name="query">The query to be materialized.</param>
        /// <returns>The result of the query.</returns>
        public static IQueryable<object> FromCache(this IQueryable query)
        {
        ...
        /// <returns>The result of the query.</returns>
        public static IQueryable<T> FromCache<T>(this IQueryable<T> query, int duration)
        {
        ...
        /// <param name="duration">The amount of time, in seconds, that a cache entry is to remain in the output cache.</param>
        /// <returns>The result of the query.</returns>
        public static IQueryable<object> FromCache(this IQueryable query, int duration)
        {
        ...
        /// <returns>The result of the query.</returns>
        public static IQueryable<T> FromCache<T>(this IQueryable<T> query, string profileName)
        {
        ...
        /// <param name="profileName">Name of the cache profile to use.</param>
        /// <returns>The result of the query.</returns>
        public static IQueryable<object> FromCache(this IQueryable query, string profileName)
        {
        ...
        /// <returns>The result of the query.</returns>
        public static IQueryable<T> FromCache<T>(this IQueryable<T> query, CacheSettings settings)
        {
        ...
        /// <param name="settings">Cache settings object.</param>
        /// <returns>The result of the query.</returns>
        public static IQueryable<object> FromCache(this IQueryable query, CacheSettings settings)
        {
