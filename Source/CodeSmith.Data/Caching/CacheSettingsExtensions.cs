...
namespace CodeSmith.Data.Caching
{
    public static class CacheSettingsExtensions
    {
        ...
        public static CacheSettings AddCacheDependency(
            this CacheSettings settings,
            params CacheDependency[] cacheDependencies)
        {
        ...
        public static CacheSettings AddCacheDependency(
            this CacheSettings settings,
            IEnumerable<CacheDependency> cacheDependencies)
        {
        ...
        public static CacheSettings AddCacheDependency(
            this CacheSettings settings,
            params SqlCacheDependency[] cacheDependencies)
        {
            ...
            params string[] sqlCacheDependencyTableNames)
        {
            ...
            return AddCacheDependency(settings, cacheDependencies);
        }

        public static CacheSettings AddCacheDependency<T>(
            this CacheSettings settings,
        ...
        public static CacheSettings WithCacheItemRemovedCallback(
            this CacheSettings settings,
