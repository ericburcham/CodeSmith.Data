...
namespace CodeSmith.Data.Serialization
{
    ...
    public class ByteArrayConverter : JavaScriptConverter
    {
        ...
        private static readonly Type[] ByteArrayTypes = { typeof(byte[]), typeof(Binary) };
        ...
        /// <value></value>
        /// <returns>
        ///     An object that implements <see cref="T:System.Collections.Generic.IEnumerable`1" /> that represents the types
        ///     supported by the converter.
        /// </returns>
        public override IEnumerable<Type> SupportedTypes => ByteArrayTypes;
