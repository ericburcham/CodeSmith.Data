...
namespace CodeSmith.Data.Rules
{
    ...
    public class BrokenRuleException : ValidationException
    {
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="CodeSmith.Data.Rules.BrokenRuleException" /> to
        ...
        public string ToString(bool includeState)
        {
            ...
            foreach (var entity in BrokenRules.GroupByEntity())
            {
                ...
                foreach (var rule in entity.Value)
                {
